					...
					<table  cellpadding="0" border="0" cellPadding="0" cellspacing="0" width="600" >
						...
						<tr>
						 <td width="34" class="leftMiddleBg"> &nbsp;</td>
							...
							<form name="changepwd" method="POST" action="changepwdhandler.jsp" id="changepwdForm"
							...
							<table   border="0" cellSpacing="0" cellpadding="0" width="90%" align="center">
								...
								<tr>
									...
									value="<c:if test='${not empty param.change_pwd_error}'><c:out value='${SPRING_SECURITY_LAST_USERNAME}'/></c:if>" />
								</tr>
								...
								<tr>
									...
									<td width="10%">&nbsp;</td>
									<td><input type="password" name="j_new_password_confirmtoshow" size="30" class="inputWidth" id="txt_newPasswordConfirmtoshow">
									</td>									
								</tr>
...
<script src="js/changepwd.js" defer></script>
